    ...
    public static boolean checkWinAi(char symb) {
        for (int col=0; col<3; col++) {
            for (int row=0; row<3; row++) {
                // Вызываем методы проверки на последовательности из 3 символов и если хоть один блок заполнен,
                // то у игрока, который проставляет этот символ приемущество
                // иначе продолжаем для другого смещения
                if (checkDiagonal(symb, col, row, winSymbols-1) || checkLanes(symb, col, row, winSymbols-1)) return true;
            }
        }
        for (int col=0; col<4; col++) {
            for (int row=0; row<4; row++) {
                ...
                // то у игрока, который проставляет этот символ приемущество
                // иначе продолжаем для другого смещения
                if (checkDiagonal(symb, col, row, winSymbols-2) || checkLanes(symb, col, row, winSymbols-2)) return true;
            }
        }
        for (int col=0; col<5; col++) {
            for (int row=0; row<5; row++) {
                ...
                if (checkDiagonal(symb, col, row, winSymbols-3) || checkLanes(symb, col, row, winSymbols-3)) return true;
            }
        }
        return false;
    }
